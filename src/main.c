...
// #define ANTENA7C    // tunnel 2" (pencil tunnel) fabricada 17-05-2024
...
#ifdef ANTENA0 // plana 125mm 23mm 1.3kg -- Plannar 5 inches
...
#ifdef ANTENA7C    // tunnel 2" R 90 L 0.29 tiene 20 capas alambre 0.40
const char s_antenna [] = { "ant7,090.00,290.00,000.52,065.50\r\n" };
const char s_name [] = { "name:Johnson Antenna\r\n" };
#endif
